...
Returns an object containing a list of [soundboard sound](#soundboard-sound-object) objects for the given guild. Includes the `user` field if the user has the `MANAGE_EXPRESSIONS` permission.
...
Returns a [soundboard sound](#soundboard-sound-object) object for the given guild and sound ID. Includes the `user` field if the user has the `MANAGE_EXPRESSIONS` permission.
